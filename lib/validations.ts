...
export const signInSchema = z.object({
  email: z.email({ error: "Please provide valid email address." }).min(1, { error: "Email is required." }),
  password: z
    .string()
...
export const UserSchema = z.object({
  ...
  email: z.string().email({ message: "Please provide a valide email address." }),
